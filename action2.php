<?php
	...
	//$navpage = '_views/navbar_action.php';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>
		...
		<div id="pagecontainer" class="container hasBackground pl-0 pr-0 pt-1">
			...
			<div id="content" style="display:<?php echo $showcontent; ?>;">
				...
				<div>
					<?php
						if (file_exists("_views/action2.php"))
						{
							require_once("_views/action2.php");
						}
						else
						{
							require_once("../_views/action2.php");
